                    ...
                    <tr id="deskNoParentContent1">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             ...
                                                             id="seatNo"/> <span style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7746"></script>
...
<script type="text/javascript">
    ...
    function submitData() {
        ...
        $.ajax({
            type: 'post',
            url: '${pageContext.request.contextPath}/admin/seat_info/add_submit',
            data: {
