        ...
        <div class="system">
            <div>
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    ...
                    <tr id="deskNoParentContent1">
                        <td align="right">座位号</td>
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" placeholder="请输入座位号"
                                                             value="${data.seatNo}" id="seatNo"/> <span style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8517"></script>
...
<script type="text/javascript">
    ...
    function submitData() {
        ...
        $.ajax({
            type: 'post',
            url: '${pageContext.request.contextPath}/admin/seat_info/update_submit',
            data: {
                "id": '${data.id}',
