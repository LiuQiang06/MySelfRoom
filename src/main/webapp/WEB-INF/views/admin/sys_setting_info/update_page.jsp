            ...
            <div>
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    ...
                    <tr id="startTimeParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.startTime}"
                                                             placeholder="请输入开始时间（请输入数字）" id="startTime"/>
                    ...
                    <tr id="endTimeParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.endTime}"
                                                             placeholder="请输入结束时间（请输入数字）" id="endTime"/>
                                <span style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr id="priceParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.price}"
                                                             placeholder="请输入价格（请输入数字）" id="price"/> <span
                    ...
                    <tr id="shopNameParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.shopName}"
                                                             placeholder="请输入店铺名" id="shopName"/> <span
                                    style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr id="shopIntroParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><textarea placeholder="请输入简介" id="shopIntro" rows="15"
                                                                cols="100">${data.shopIntro}</textarea> <span
                                    style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr id="addressParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.address}"
                                                             placeholder="请输入地址" id="address"/> <span
                                    style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4909"></script>
