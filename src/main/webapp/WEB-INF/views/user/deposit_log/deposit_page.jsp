...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1742"></script>
...
<script type="text/javascript">
    ...
    function submitData() {
        ...
        $.ajax({
            type: 'post',
            url: '${pageContext.request.contextPath}/user/deposit_log/deposit_submit',
            data: {
            ...
            success: function (result) {
                if (result.code == 0) {
                    ...
                    alert(result.msg);
                    window.location.href = "${pageContext.request.contextPath}/user/deposit_log";
                }
            }
        });
    }
