    ...
    <div>
        ...
        <div style="display:inline">
            <p style="display:inline-block;margin-top:30px">
                ...
                <input type="text" class="inpMain" style="color:black;width:250px;" placeholder="请输入充值编号进行查询"
                       id="depositNo"/>
            </p>
        </div>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6321"></script>
...
<script type="text/javascript">
    ...
    function ajaxList(page) {
        ...
        $.ajax({
            type: 'get',
            url: "${pageContext.request.contextPath}/user/deposit_log/queryList",
            data: {
