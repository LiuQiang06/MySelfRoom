...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <div style="margin-left:20px;margin-top:10px;">
        <%--                         <a href="${pageContext.request.contextPath}/user/order_info/order_desk?deskId=${data.deskId}" class="btnGreen">新增</a> --%>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2924"></script>
...
<script type="text/javascript">
    ...
    function ajaxList(page) {
        ...
        $.ajax({
            type: 'get',
            url: "${pageContext.request.contextPath}/user/order_info/queryList",
            data: {
                "deskId": "${data.deskId}",
    ...
    function td(e) {
        ...
        if (r == true) {
            ...
            $.ajax({
                type: 'get',
                url: "${pageContext.request.contextPath}/user/order_info/td",
                data: {
                    "id": id
                },
                success: function (result) {
