            ...
            <div>
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    ...
                    <tr id="realNameParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.realName}"
                                                             placeholder="请输入姓名" id="realName"/> <span
                    ...
                    <tr id="celPhoneParentContent">
                        ...
                        <td>
                            <div style="width:720px;"><input type="text" class="inpMain"
                                                             style="color:black;width:500px;" value="${data.celPhone}"
                                                             placeholder="请输入联系电话" id="celPhone"/> <span
                                    style="color:red">*必填</span>
                            </div>
                        </td>
                    </tr>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4158"></script>
